...
const file_catalog_v1_catalog_proto_rawDesc = "" +
	...
	"\vGetProducts\x12\x1e.catalog.v1.GetProductsRequest\x1a\x1f.catalog.v1.GetProductsResponse\"%\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/v1/catalog/products/batchB\xb9\x01\n" +
	"\x0ecom.catalog.v1B\fCatalogProtoP\x01ZPgithub.com/KDarenskii/catalog-service/internal/pkg/grpc/gen/catalog/v1;catalogv1\xa2\x02\x03CXX\xaa\x02\n" +
	"Catalog.V1\xca\x02\n" +
